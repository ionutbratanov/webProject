...
public class LoadFromCsv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(request.getParameter("CUIFurnizor")
		...
		try {
			...
			while (it.hasNext()) {
				...
				if (f==null) System.out.println("firma e null! linia e"+i);
				if (f.getCUI()==null) System.out.println("getCui e null! linia e"+i);
				...
				i++;
				if ((firmaFurnizor!=null)&&(firmaClient!=null)) break;
			}
		...
		request.getSession().setAttribute("persoanaEmitenta",persEm);//request.getSession-iau sesiunea curenta, setAttribute- pun pe sesiune
